...
data class Cocktail(
    ...
    val strAlcoholic: String?,      // <-- ADD THIS
    val strGlass: String?,          // <-- AND THIS
    val strInstructions: String?,   // <-- AND THIS

    // Optional fields if you want to extract ingredients later:
